...
namespace dae
{
    ...
    public:
        ...
        void WorldToGrid(const glm::vec3& topLeft, int& outGridX, int& outGridY) const;
        glm::vec3 GridToWorld(int gridX, int gridY) const;

        bool IsWallAt(const glm::vec3& topLeft) const;

        bool SlideOrBreakAt(const glm::vec3& topLeft,
            int dirX, int dirY,
